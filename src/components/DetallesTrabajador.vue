<template>
  ...
  >
    <v-container>
      <v-card height="700">
        ...
        <div class="d-flex flex-row">
          <v-tabs v-model="tab" color="primary" direction="vertical">
            ...
            <v-tab value="vacaciones">
              <v-icon start> beach_access </v-icon>
              Vacaciones
            </v-tab>
            ...
            <v-tab value="inducciones">
              <v-icon start> sensor_occupied </v-icon>
              Inducciones
            </v-tab>
            <v-tab value="descargos">
              <v-icon start> upload_file </v-icon>
              Descargos
            </v-tab>
            <v-tab value="memorandums">
              <v-icon start> document_scanner </v-icon>
              Memorandums
            </v-tab>
          </v-tabs>
      ...
      <v-footer><v-btn @click="cerrarModal" prepend-icon="cancel" color="red">Cerrar</v-btn></v-footer>
    </v-container>
  </v-dialog>
</template>
...
<script>
export default {
  props: ["idTrabajador", "descripcion"],
  data() {
    return {
      mostrarModal: true,
      tab: "contratos",
